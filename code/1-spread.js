...
const totalFruits = ["startingFruits", ...startingFruits, "moreFruits"];
...
console.log("coloredCar", coloredCar);
...
function updateCarModel(coloredCar, model) {
  return {
    ...coloredCar,
    model,
  };
...
console.log(updateCarModel(coloredCar, "Camry"));
